...
def get_argument_parser():
    ...
    parser.add_argument('--logger_name', default='runs/test', help='Path to save checkpoints and logs.')
    ...
    parser.add_argument('--f30k_img_path', type=str, default='data/flickr30k-images', help='path to Flickr30K images') 
    parser.add_argument('--coco_img_path', type=str, default='data/coco-images', help='path to MS-COCO images') 
